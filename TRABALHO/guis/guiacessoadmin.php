...
<div id="example" class="post">
			<div class="title">
				<h2><!-- InstanceBeginEditable name="titulo" -->Essse acesso e apenas para administradores!<!-- InstanceEndEditable --></h2>
	  </div>
			<div class="story"><!-- InstanceBeginEditable name="texto" -->
            <form id="form1" method="post" action="../controles/usuariocontrole.php?operacao=logar">
					  <label>E-mail<br />
					  <br />
