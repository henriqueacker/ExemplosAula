...
<div id="example" class="post">
			<div class="title">
				<h2><!-- InstanceBeginEditable name="titulo" -->Adicione suas fotos<!-- InstanceEndEditable --></h2>
	  </div>
...
?>
            <form action="../controles/imagenscontrole.php" method="post" enctype="multipart/form-data" id="form1">
			  <label><input type="file" name="foto" id="foto" />
		    </label>
			      <p>&nbsp;</p>
			      <p>
			        <label>
