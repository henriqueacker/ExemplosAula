...
<div id="example" class="post">
			<div class="title">
				<h2><!-- InstanceBeginEditable name="titulo" -->Altere sua senha<!-- InstanceEndEditable --></h2>
	  </div>
			<div class="story"><!-- InstanceBeginEditable name="texto" -->
            <form id="form1" method="post" action="../controles/usuariocontrole.php?operacao=alterarsenha">
              <label>Senha Antiga<br />
              <input type="text" name="txtsenhaantiga" id="txtsenhaantiga" />
              </label>
              <p>
                          <label>Nova Senha<br />
                          <input type="text" name="txtnovasenha" id="txtnovasenha" />
                          </label>
              </p>
              <p>
                <label>Confirmar Nova Senha<br />
                <input type="text" name="txtconfirmacao" id="txtconfirmacao" />
                </label>
</p>
              <p>
                <label>
