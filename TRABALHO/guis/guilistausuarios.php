<?php
session_start();
include_once '../controles/controleacesso.php';
if(!isset($_SESSION['listausuarios'])){
	//se a sessão listausuarios não tiver sido criada, redireciona para o controle solicitando a lista de usuarios e encerra
	header('location:../controles/usuariocontrole.php?operacao=listar');
	exit();
}
 ?>
...
<div id="example" class="post">
			<div class="title">
				<h2><!-- InstanceBeginEditable name="titulo" -->Lista de usuarios<!-- InstanceEndEditable --></h2>
	  </div>
			<div class="story"><!-- InstanceBeginEditable name="texto" -->
			 <?php
					include_once '../classes/usuario.class.php';
					$lista = unserialize($_SESSION['listausuarios']);
					foreach($lista as $u){
						echo "<p>Nome: $u->nome<br />
							     E-mail: $u->email</p><hr />";
					}
