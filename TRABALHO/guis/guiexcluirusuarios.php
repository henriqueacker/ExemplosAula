...
<div id="example" class="post">
			<div class="title">
				<h2><!-- InstanceBeginEditable name="titulo" -->Exclua um usuario!!!<!-- InstanceEndEditable --></h2>
	  </div>
			<div class="story"><!-- InstanceBeginEditable name="texto" --><form id="form1" method="post" action="../controles/usuariocontrole.php?operacao=excluir">
			  <label></label>
              ...
              <option value="0">Selecione um usuário</option>
                  <?php
                      ...
                      foreach($lista as $u)
                      	echo "<option value='$u->id'>$u</option>";
